...
{
    //private static readonly string BANEDWORDS_FILE_PATH = "./TOHEV-DATA/BanWords.txt";
    ...
    //                File.WriteAllText(BANEDWORDS_FILE_PATH, GetResourcesTxt($"TOHEV.Resources.Config.BanWords.{fileName}.txt"));
    //            }
    //        }
    //        catch (Exception ex)
    //        {
