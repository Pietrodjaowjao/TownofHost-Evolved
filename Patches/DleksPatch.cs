...
class AllMapIconsPatch
{
    ...
    public static void Postfix_AllMapIcons(GameStartManager __instance)
    {
        ...
        DleksIncon.MapImage = Utils.LoadSprite($"TOHEV.Resources.Images.DleksBanner.png", 100f);
        DleksIncon.NameImage = Utils.LoadSprite($"TOHEV.Resources.Images.DleksBanner-Wordart.png", 100f);
