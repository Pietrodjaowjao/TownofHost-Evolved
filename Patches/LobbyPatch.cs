...
public class LobbyStartPatch
{
    ...
    {
        LobbyPaintSprite = Utils.LoadSprite("TOHEV.Resources.Images.LobbyPaint.png", 290f);
        DropshipDecorationsSprite = Utils.LoadSprite("TOHEV.Resources.Images.Dropship-Decorations.png", 60f);
    }
